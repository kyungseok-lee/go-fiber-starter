...
- 2026-09-22 최신 안정판 확인: validator v10.30.5, PostgreSQL 드라이버 v1.6.3, SQLite 런타임 v1.59.0 및 관련 간접 의존성 갱신(libc는 SQLite 요구 버전 v1.75.7 사용)
- README에 현재 직접 의존성 버전 표를 추가하고, 기여 가이드의 안정판 확인·테스트 의존성 갱신·SQLite 호환성·검증 절차 최신화
